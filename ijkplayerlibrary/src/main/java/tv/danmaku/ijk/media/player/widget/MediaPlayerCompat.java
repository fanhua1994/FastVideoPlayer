...
public class MediaPlayerCompat {
	public static String getName(IMediaPlayer mp) {
		if (mp == null) {
			...
			IMediaPlayer internalMediaPlayer = ((TextureMediaPlayer) mp)
	...
	public static IjkMediaPlayer getIjkMediaPlayer(IMediaPlayer mp) {
		...
		} else if (mp instanceof MediaPlayerProxy && ((MediaPlayerProxy) mp)
				.getInternalMediaPlayer() instanceof IjkMediaPlayer) {
			ijkMediaPlayer = (IjkMediaPlayer) ((MediaPlayerProxy) mp)
					.getInternalMediaPlayer();
		}
